    ...
    <section id="why" className="py-24 md:py-32 px-6 bg-[#F9EFEF]">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* Eyebrow */}
            <span className="inline-block text-[#1D1D2B] font-bold uppercase tracking-widest text-s mb-4">
              {t("why_eyebrow")}
            </span>

            {/* Heading */}
            <h2 className="text-2xl md:text-3xl font-black text-[#1D1D2B] leading-tight mb-6">
              {t("why_title")}
            </h2>

            {/* Body */}
            <p className="text-[#1D1D2B]/60 text-s md:text-s leading-relaxed mb-10 max-w-lg">
              {t("why_body")}
            </p>
          ...
          >
            {features.map((f, i) => (
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-[#AEADF0] text-[#1D1D2B] flex items-center justify-center shrink-0">
                  {f.icon}
                </div>
                <div>
